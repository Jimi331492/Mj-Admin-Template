 ...
 * @Description: 
 * @FilePath: \music-web-vue\src\views\features\Test.vue
 * @LastEditTime: 2021-11-03 05:58:37
  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="logList" border stripe>
        ...
        <el-table-column prop="pagename" label="一个字段"></el-table-column>
        <el-table-column prop="path" label="一个字段"> </el-table-column>
        <el-table-column prop="time" label="一个字段"> </el-table-column>
      </el-table>
